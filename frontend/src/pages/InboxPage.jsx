          ...
          <div className={`flex flex-col border-r border-slate-100 overflow-y-auto transition-all ${selectedEmail ? 'w-72 shrink-0' : 'flex-1'}`}>
            <div className="p-3 border-b border-slate-100 sticky top-0 bg-white z-10 shrink-0">
              <input 
                ...
                className="w-full bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 rounded-xl px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 font-medium transition-all"
              />
            </div>
            {loading ? (
              ...
              <div className="p-4 border-b border-slate-100 flex items-start gap-3 shrink-0 bg-white">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <button onClick={handleReply} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold rounded-xl transition flex items-center gap-1.5 border border-slate-200 shrink-0">
                  ...
                  <div className="p-4 border-b border-slate-100 bg-slate-50/50 flex flex-wrap gap-2 shrink-0">
                    ...
                    {emailBody.attachments.map((att, idx) => (
                      <a
                        ...
                        className="flex items-center gap-2 px-3 py-1.5 bg-white border border-slate-200 rounded-xl shadow-sm hover:border-sky-300 hover:text-sky-700 transition text-xs font-semibold text-slate-700"
                      >
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden border border-slate-200 flex flex-col">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-4 text-white flex items-center justify-between">
              ...
              <button onClick={() => setShowCompose(false)} className="text-blue-200 hover:text-white transition">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="p-4 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <input 
                  ...
                  className="flex-1 p-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-sky-500" 
              ...
              <div className="flex items-start gap-3 flex-1">
                <textarea 
                  ...
                  className="flex-1 p-3 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 min-h-[250px] resize-none"
                  placeholder="Write your email here..."
                ></textarea>
              </div>
            </div>
            <div className="bg-slate-50 p-4 border-t border-slate-200 flex justify-end gap-3">
              <button onClick={() => setShowCompose(false)} className="px-4 py-2 bg-white border border-slate-200 text-slate-700 font-bold text-sm rounded-xl hover:bg-slate-50 transition">Cancel</button>
